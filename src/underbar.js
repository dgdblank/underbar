(function() {
  ...
  _.reduce = function(collection, iterator, accumulator) {
    var base = (arguments.length < 3) ? collection.shift() : accumulator;
  ...
  _.every = function(collection, iterator) {
    // TIP: Try re-using reduce() here.
      ...
      return _.reduce(collection, function(base, element){
        if (!base) {
          return false;
        }
  ...
  _.invoke = function(collection, functionOrKey, args) {
        ...
        if (typeof(functionOrKey) === 'function') {
          ...
          _.each(collection, function(element, index) {
            var object = typeof(element);
            result.push(object[functionOrKey].apply(element));
          });
        }
  ...
  _.zip = function() {
    ...
    for(var i = 0; i < arguments[0].length; i++){
      ...
      for(var args = 0; args < arguments.length; args++){
        sameIndex.push(arguments[args][i])
      }
      result.push(sameIndex);
    }
  ...
  _.flatten = function(nestedArray, result) {
    return _.reduce(nestedArray, function(base, notFlat){
      return base.concat(Array.isArray(notFlat) ? _.flatten(notFlat) : notFlat);
    }, [])
  };
  ...
  // every item shared between all the passed-in arrays.
   _.intersection = function(array) {
    // Doesn't work for more than two arrays **
     var args = Array.prototype.slice.call(arguments);
     var first = args.shift();
     var second = args.shift();
     var result = [];

     result = _.filter(first, function(n){
      return _.indexOf(second, n) != -1;
     })

     return first.length === 1 ? array : result;
  };
